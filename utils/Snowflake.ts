const EPOCH = 1598918400000 // change your EPOCH;
let INCREMENT = 0;

function binaryToID(num: string): string {
    let dec = "";
    while (num.length > 50) {
...
function idToBinary(num: string): string {
    let bin = "";
...
function isSnowflake(snowflake: string): boolean {
